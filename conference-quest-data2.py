...
def index():
    ...
    if query:
        ...
        return render_template('results.html', query=query, results=results, city=city, en_date=en_date, st_date=st_date, check=check, start_date=start_date,end_date=end_date)
    else:
